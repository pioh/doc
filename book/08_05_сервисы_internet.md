...
### Протоколы почты (краткое напоминание из [Глава 8.04](08_04_протоколы_internet.md))
...
**Все эти сервисы** построены на протоколах, которые мы разобрали в [Глава 8.04](08_04_протоколы_internet.md) (TCP, UDP, HTTP, DNS). Протоколы — это **фундамент**, а сервисы — это **здания**, которые на нём стоят.
